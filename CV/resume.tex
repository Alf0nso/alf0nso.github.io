...
\begin{rSection}{SKILLS}
  \begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
    ...
    C, C++, Fortran, LLVM, Haskell, Lisp, Typescript, Python \\
...
%%    Drummer (5 years), Guitarist (6 years), Amateur choir
    ...
    Português (nativo), Español (avanzado, uso profesional), \\
...
\begin{rSection}{EXPERIENCE}
  ...
  \textbf{Compiler Researcher/Engineer} \hfill Nov 2023 - Now\\
  ...
  \item Help fight back against ``bit rotting'' (fix and patch forgotten code).
  \item Help with bugs in LLVM (example: \href{https://github.com/llvm/llvm-project/issues/134986}{issue})
  \end{itemize}
...
\begin{rSection}{Outside of Job}  
  ...
  \begin{itemize}
    \itemsep -3pt {} 
  \item Fix warnings in \href{https://github.com/supercollider/scel}{sclang mode} (\href{https://github.com/supercollider/scel/pull/63}{pull request}).
  \end{itemize}
